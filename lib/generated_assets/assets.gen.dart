...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/error_cat.png
  AssetGenImage get errorCat =>
      const AssetGenImage('assets/images/error_cat.png');

  /// List of all assets
  List<AssetGenImage> get values => [errorCat];
}
...
class $AssetsSvgGen {
  ...
  /// List of all assets
  List<String> get values => [arrowLeft, calendar, settings];
}
